...
use super::{
    binary_request::BinaryRequest, binary_response_header::BinaryResponseHeader, db_id::DbId,
    payload_type::PayloadType, DbRawBytesSpec, ErrorCode, PROTOCOL_VERSION,
};
...
impl BinaryResponse {
    pub fn new_empty() -> Self {
        Self { header: BinaryResponseHeader::new(None), payload: vec![] }
    }
